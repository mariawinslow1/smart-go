  ...
  return (
    <div className="site-shell">
      ...
      <header className="topbar">
        <div className="container nav-wrap">
          ...
          <nav className="desktop-nav" aria-label="Основная навигация">
            ...
            <NavLink to="/audit" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>Бесплатный разбор</NavLink>
          </nav>
      ...
      <footer className="footer"><div className="container footer-grid">
        ...
        <nav className="footer-links" aria-label="Навигация в подвале"><Link to="/method">Как проходит анализ</Link><Link to="/cases">Примеры выводов</Link><a href="/#pricing">Стоимость</a><Link to="/audit">Бесплатный разбор</Link><Link to="/privacy">Политика конфиденциальности</Link></nav>
